...
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(CameraProjectionPointsModel,DataTypes),
...
public:
    CameraProjectionPointsModel(MechanicalState* object = nullptr);
    ~CameraProjectionPointsModel() override;
